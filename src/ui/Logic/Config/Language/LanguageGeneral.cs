...
public class LanguageGeneral
{
    ...
    public string FolderScanCompleted { get; set; }
    public string FolderScanProgress { get; set; }
    public string FolderScanRemaining { get; set; }
    public string FolderScanTotal { get; set; }
    ...
    public string NoVideoFilesFoundInFolder { get; set; }
    ...
    public LanguageGeneral()
    {
        ...
        Format = "Format";
        Forward = "Forward";
        FolderScanCompleted = "Completed: {0}";
        FolderScanProgress = "{0} / {1}";
        FolderScanRemaining = "Remaining: {0}";
        FolderScanTotal = "Total: {0}";
        ...
        NoSymbolLines = "#Lines";
        NoVideoFilesFoundInFolder = "No video files found in folder";
