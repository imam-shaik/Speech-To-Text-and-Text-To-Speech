...
using Nikse.SubtitleEdit.Features.Video.TextToSpeechText;
    ...
    IApplySsaStyles
{
    ...
    [RelayCommand]
    private async Task ShowTextToSpeechText()
    {
        if (Window == null)
        {
            return;
        ...
        await ShowDialogAsync<TextToSpeechTextWindow, TextToSpeechTextViewModel>(vm =>
        {
        });
    }
